...
public class CategoryBrandRelationController {
    ...
    public R getBrandsListByCatId(@RequestParam("catId") Long catId) {
        List<CategoryBrandRelationEntity> entities = categoryBrandRelationService.getRelatedBrands(catId);
