...
public class MemberReceiveAddressServiceImpl extends ServiceImpl<MemberReceiveAddressDao, MemberReceiveAddressEntity> implements MemberReceiveAddressService {
	...
	@Override
	public List<MemberReceiveAddressEntity> queryByMemberId(Long memberId) {
		List<MemberReceiveAddressEntity> address = this.list(Wrappers.lambdaQuery(MemberReceiveAddressEntity.class)
